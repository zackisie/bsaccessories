					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                ...
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del><?php echo 'RM' ?><?php echo $p_old_price; ?></del>
                                    <?php endif; ?> 
                                        <?php echo 'RM' ?><?php echo $p_current_price; ?>
                                </span>
                            </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo 'RM' ?><?php echo $row['p_current_price']; ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        <?php echo 'RM' ?><?php echo $row['p_old_price']; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
